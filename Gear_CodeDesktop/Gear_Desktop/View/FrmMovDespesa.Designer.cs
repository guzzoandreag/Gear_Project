namespace Gear_Desktop.View
{
    partial class FrmMovDespesa
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.pnlCenterCabecalhoRodape.Controls.Add(this.txtDes_valor);
            this.pnlCenterCabecalhoRodape.Controls.Add(this.label6);
            this.pnlCenterCabecalhoRodape.Controls.Add(this.txtDes_observacao);
            ...
            this.pnlCenterCabecalhoRodape.Controls.SetChildIndex(this.txtDes_observacao, 0);
            this.pnlCenterCabecalhoRodape.Controls.SetChildIndex(this.label6, 0);
            this.pnlCenterCabecalhoRodape.Controls.SetChildIndex(this.txtDes_valor, 0);
